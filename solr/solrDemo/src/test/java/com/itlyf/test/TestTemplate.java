...
public class TestTemplate {
    ...
    public void testPageQuery() {
        ...
        for (TbItem item : page.getContent()) {
            System.out.println(item.getId()+"  "+item.getTitle()+"  "+item.getPrice()+"  "+item.getBrand());
        }
    ...
    @Test
    public void testPageConditionQuery() {
        Query query = new SimpleQuery("*:*");
