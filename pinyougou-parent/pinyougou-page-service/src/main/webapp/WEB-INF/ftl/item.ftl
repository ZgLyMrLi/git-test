                            ...
                            <dl>
                                ...
                                <#list specification.attributeValue as attributeValue>
                                    <dd><a href="javascript:;"
                                           class='{{isSelected("${specification.attributeName}","${attributeValue}")?"selected":""}}'
                                           ng-click="optionSpec('${specification.attributeName}','${attributeValue}')">${attributeValue}
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    <input autocomplete="off" type="text" ng-model="num" value="{{num}}"
                                           minnum="{{num}}" class="itxt"/>
